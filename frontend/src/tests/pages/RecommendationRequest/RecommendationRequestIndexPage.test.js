...
describe("RecommendationRequestIndexPage tests", () => {
    ...
    test("renders three recommendation requests correctly for regular user", async () => {
        ...
        const createRestaurantButton = screen.queryByText("Create Recommendation Request");
        expect(createRestaurantButton).not.toBeInTheDocument();

        const requesterEmail = screen.getByText("jjoestar@ucsb.edu");
        expect(requesterEmail).toBeInTheDocument();

        const professorEmail = screen.getByText("jseinfeld@ucsb.edu");
