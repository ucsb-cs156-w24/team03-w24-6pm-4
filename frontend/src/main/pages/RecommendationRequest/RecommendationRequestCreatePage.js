...
export default function RecommendationRequestCreatePage() {
    const objectToAxiosParams = (recommendationRequest) => ({
      ...
      const onSuccess = (recommendationRequest) => {
        toast(`New Recommendation Request Created - requesterEmail: ${recommendationRequest.requesterEmail} professorEmail: ${recommendationRequest.professorEmail} explanation: ${recommendationRequest.explanation} dateRequested: ${recommendationRequest.dateRequested} dateNeeded: ${recommendationRequest.dateNeeded} done: ${recommendationRequest.done}`);
      }
