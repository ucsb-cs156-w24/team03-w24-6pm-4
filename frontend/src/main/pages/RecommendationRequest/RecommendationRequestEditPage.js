...
export default function RecommendationRequestEditPage({storybook=false}) {
    ...
    const onSuccess = (recommendationRequest) => {
        toast(`Recommendation Request Updated - requesterEmail: ${recommendationRequest.requesterEmail} professorEmail: ${recommendationRequest.professorEmail} explanation: ${recommendationRequest.explanation} dateRequested: ${recommendationRequest.dateRequested} dateNeeded: ${recommendationRequest.dateNeeded} done: ${recommendationRequest.done}`);
    }
